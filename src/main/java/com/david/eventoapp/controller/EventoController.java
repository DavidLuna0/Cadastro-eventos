...
public class EventoController {
	...
	//@Autowired - Toda vez que precisar usar essa interface será criada umka nova instancia automaticamente
	@Autowired
	...
	//metodo get pois retorna formulario
	...
	//metodo para receber lista de eventos
	@RequestMapping("/eventos")
	public ModelAndView listaEventos() {
		ModelAndView mv = new ModelAndView("index");
		//buscar eventos no banco de dados
		Iterable<Evento> eventos = er.findAll();
		//passar a lista de eventos para a view e já renderiza a mesma para a pagina
